(function() {
  var mightyDatepicker;

  mightyDatepicker = function($compile) {
  ...
  mightyDatepicker.$inject = ['$compile'];

  angular.module("mightyDatepicker", ['pasvaz.bindonce']).directive("mightyDatepicker", mightyDatepicker);
